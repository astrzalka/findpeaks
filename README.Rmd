...
You can install the released version of findpeaks from Github, but first other R packages have to be installed:
...
```
Windows users need to first install [Rtools 4.0.0](https://cran.r-project.org/bin/windows/Rtools/), which is necessary for package compilation from source, and then install package Peaks as above. 
...
All analysis and plotting functions can be used outside of shiny application as shown in the example below:
